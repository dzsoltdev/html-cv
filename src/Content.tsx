        ...
        details={<>
          <section>
            ...
            <div>I am a frontend-focused engineer, eager to find the best solutions for the most challenging tasks -
              this is what really keeps me motivated in my job. I am not afraid of working on projects with new frameworks and technologies
              since I believe a steep learning curve fosters development very effectively. My preferred framework is React, I'm working with it since 2015 and
              I think it's very easy to learn and understand it's fundamentals.
            </div>
          </section>
          ...
          <section>
            ...
            <div className={'sub-title'}>Microsoft 70-583 (Pro: Designing and Developing Microsoft Azure Application)</div>
            <div>2014</div>
          </section>
          ...
          <section>
              ...
              <AccordionDetails className={'accordion-details'}>
                ...
                <div>
                  <p>
                    ...
                    It was a special project for me, because as a freelancer, I was the only responsible for the entire project, including the communication
                    with custumer about the needs and also about the opinions.
                    I extended the design and the features continuously, following the agile methodology and also made the deployment to Firebase.
                  </p>
                </div>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion className={classNames('accordion-container', {export: appMode === APP_MODE.EXPORT})}
              ...
              <AccordionDetails className={'accordion-details'}>
                ...
                <div className={'label'}>Tech. Stack</div>
                <div>HTML, SCSS, JavaScript, TypeScript, OJET, React, Redux, webpack, REST API, React Native, Karma, Mocha, Chai, Sinon, Micro frontend, npm, git, Jenkins</div>
                <div className={'label'}>Project Summary</div>
                <div>
                  <p>
                    As a part of an international team (the teammates are from US, Mexico and Hungary), my recent project is an analytical tool, which helps Oracle's
                    specialist to improve customer satisfaction by highlighting known issues based on a huge data set. The development started in React Native,
                    but due some business reasons, we switched to OJET framework. The biggest challenge was to pick up enough knowledge of OJET ecosystem
                    to start delivery as soon as possible and fortify the project with 3rd party libs, eg. with redux, which was extremely difficult to integrate with OJET.
                    Do to my ability to solve architectural issues and find working solutions to the most of the business needs, I've become the lead of the
                    frontend part of the project, so my set of roles has been expanded with to give suggestions and to make decisions on any technical issues,
                    as well as to mentor my colleagues.
                  </p>

                  <p>
                    Nowdays I'm working on a React alternative of this project. I've developed the whole app from scratch and started to transfer all existing features
                    from the OJET version and solve all the business needs, what we weren't able to reach with the other framework. As part of the app,
                    I'm working on a micro frontend architecture based solution to be able to share the codebase between teams and use existing,
            ...
            <Accordion className={classNames('accordion-container', {export: appMode === APP_MODE.EXPORT})}
              ...
              <AccordionDetails className={'accordion-details'}>
                ...
                <div>
                  <p>
                    This tool is the responsible for the schedule optimization in the most of the Bayer's factories in Italy and Germany.
                ...
                <div>
                  <p>
                    ...
                    of an innovative visual event planning platform. Due to its nature as an in-house startup, I was given free reign in trying out
                    new React methodologies to optimize our feature development pipeline, like building reusable app components.
                  </p>
                </div>
                ...
                <div>
                  <p>
                    It is a cost engineering tool (owned by McKinsey & Company), built to optimize manufacturing processes of large multinationals, based on advanced benchmarking analytics.
                    I was part of the team responsible for the entire redesign & implementation of the UI, based on the ReactJS framework,
                    as well as implementing test-driven methodologies within the Scrum feature team.
                  </p>

                  <p>
                    During this project, for a couple of months, I worked as a full stack developer and my task was to implement nodeJS features to export
                ...
                <div>
                  <p>
                    This is a document manager tool (owned by McKinsey & Company) to help organize periodically generated surveys and client responses
                    with custom templates for McKinsey & Company and partner companies. It was a small project with a short, one month development period,
                    in which my team’s role was to plan and deliver a web based solution with the given functionalities.
                  </p>
                </div>
                ...
                <div>
                  <p>
                    ...
                    tasks like creating the build system of the front end part to deploy it to different environments, and to keep the used 3rd party
                ...
                <div>
                  <p>
                    This tool is a knowledge platform for banks and other financial institutions (owned by McKinsey & Company) to help them stay ahead
                    of digital disruption. As a beginner AngularJS developer, I joined the team on the maintaining stage of the project,
            ...
            <Accordion className={classNames('accordion-container', {export: appMode === APP_MODE.EXPORT})}
              ...
              <AccordionDetails className={'accordion-details'}>
                ...
                <div>
                  <p>
                    It was my first project as a front end developer in collaboration with colleagues from abroad on a system analytical tool for mobile networks,
                    I created & extended ReactJS components with keeping TDD and A-TDD rules, while also maintained the existing code base and test case set.
                  </p>
                </div>
                ...
                <div>
                  <p>
                    I think, it isn't necessary to introduce 3G mobile systems, which was my first project in corporate environment.
                    I made performed development and maintenance works on the 3G core modules of Nokia system, also prepared module tests.
                  </p>
                </div>
              </AccordionDetails>
            </Accordion>
